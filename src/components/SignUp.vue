    ...
    <b-row>
      <b-col>
        <sorry v-if="setupErrorState">
          ...
          If the problem continues, please let me know by filling out the
          contact form. Thanks.
        </sorry>

        <div v-if="!setupErrorState">
          <wait-list
            v-if="signupClosed || signupFull"
          ...
          >
            <b-alert variant="warning" dismissible fade>
              Please do not sign-up unless you are 100% sure your child is able
              to participate in lessons and you are flexible enough to be placed
              at the lesson time given.
            </b-alert>
            ...
            <b-card bg-variant="light" class="mb-3">
              ...
              >
                <b-form-row>
                  <b-col md="4">
                    <b-form-input
                      required
                      :state="isFilled(form.parent.name)"
                      type="text"
                  ...
                  <b-col md="4">
                    <b-form-input
                      required
                      :state="isFilled(form.parent.email)"
                      type="email"
                  ...
                  <b-col md="4">
                    <b-form-input
                      :state="isFilled(form.parent.phone)"
                      type="tel"
              ...
              <b-form-group
                label="How many children are you signing up?"
                label-class="font-weight-bold"
              >
                <b-form-radio-group
                  buttons
            ...
            <div v-if="drawComponents">
              ...
              >
                <child-info
                  v-model="form.children[childNum - 1]"
            ...
            <b-card bg-variant="light" class="mb-3">
              <b-form-group
                label="Comments / Special Requests / Needs"
                label-size="lg"
                label-class="font-weight-bold"
            ...
            <b-card bg-variant="light" class="mb-3">
              ...
              >
                ...
                <b-form-text tag="span" text-variant="black">
                  * Your card will only be charged after JJ confirms your lesson
                  times
                </b-form-text>
              </b-form-group>
            ...
            <div class="my-3">
              ...
              >
                <b-button
                  :disabled="!formComplete || sendingState"
                  class="ld-ext-right"
            ...
            >
              <p>
                You have completed the signup process. JJ will confirm your
                exact lesson times <strong>within the next 2 weeks.</strong> If
                you have any additional questions, please let her know by using
                the contact form.
              </p>
            </b-modal>
            ...
            <b-alert
              variant="danger"
              dismissible
              @dismissed="state = 'ready'"
              fade
              :show="submitErrorState"
            >
              <h4>Sorry</h4>
              <p>
                There was a problem submitting your sign-up form. You can try
                reloading the page and trying again. Please use the contact form
                if the problem continues or you need help. Thanks.
              </p>
            </b-alert>
          </b-form>
        </div>
...
/* fix issue with mobile button hover sticking after deselect */
