...
func TestApp_createSignupForm(t *testing.T) {
	tests := []struct {
		name    string
		json    []byte
		wantErr bool
	}{
		{"Bob", []byte(`{"author": "Alfred E. Neuman", "text": "What, me worry?", "source": "MAD Magazine"}`), false},
		{"Larry", []byte(`{"author": "Alfred E. Neuman", "text": "What, me worry?", "source": "MAD Magazine"}`), true},
	}
